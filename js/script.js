...
function caruselOne() {
    ...
    circle1.onclick = function () {
        ...
        circle[1].style.color = "#73c0c1";
        circle[2].style.color = "#73c0c1";
...
let deadline = new Date(Date.parse(new Date()) + 6 * 24 * 60 * 60 * 1000);
let deadline2 = new Date(Date.parse(new Date()) + 7 * 24 * 60 * 60 * 1000);
let deadline3 = new Date(Date.parse(new Date()) + 12 * 24 * 60 * 60 * 1000);
let deadline4 = new Date(Date.parse(new Date()) + 1 * 24 * 60 * 60 * 1000);
let deadline5 = new Date(Date.parse(new Date()) + 9 * 24 * 60 * 60 * 1000);
let deadline6 = new Date(Date.parse(new Date()) + 1 * 24 * 60 * 60 * 1000);
