    ...
    create() {
        ...
        for (let i = 0; i < productsCart.length; i++) {
            ...
            let price = createOneProduct.getProductItem({
                tagName: 'div',
                className: 'price',
                textName: `Per unit: ${productsCart[i].price} BYN`
            });
            let total_price = createOneProduct.getProductItem({
                tagName: 'div',
                className: 'total_price',
                textName: `Total amount: ${JSON.parse(localStorage.getItem('Sum' + productsCart[i].id))} BYN`
            });
            ...
            plus.addEventListener('click', function () {
                ...
                total_price.innerHTML = 'Total amount: ' + (total_price.innerHTML) + " BYN";
                ...
                for (let i = 0; i < sum.length; i++) {
                    ...
                    text.innerHTML = 'Subtotal: ' + result + ' BYN';
            ...
            close.addEventListener('click', function () {
                ...
                localStorage.setItem('total', JSON.stringify(text.innerHTML));
                text.innerHTML = 'Subtotal: ' + (text.innerHTML) + " BYN";
